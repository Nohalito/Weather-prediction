...
For our first view of our datasets, it can be summarized pretty quickly.

Firstly, with the time series forecast exercise, we will try to check if there is 
...
Secondly for the prediction part, we can observe the following table : \par
...
\begin{itemize}
    \item Some features are cleary uncorrelated to the target (a more in-depth analysis \cite{Whatever 4}) 
