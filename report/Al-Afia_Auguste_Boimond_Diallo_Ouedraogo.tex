...
The estimation results \textbf{\cite{SARIMA}\cite{RMSE_SARIMAN}} highlight the importance of seasonal dynamics. Seasonal autoregressive and
...
This subsection presents the estimation results \textbf{\cite{OLS}\cite{RMSE_OLS}} for daily energy consumption using a cross-sectional
...
\bibitem{RMSE_SARIMAN}
\begin{table}[htbp]
\centering
\caption{Rolling Forecast Model Performance}
